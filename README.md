...
| Fact | Value |
|---|---|
| Founder | Jorge Beltrán Liévano |
| Operating since | 1998 |
| Brands operated under MAAS | 200+ |
| Active cohort 2026 | 18 brands |
| Geographic scope | LATAM enterprise (Bogotá · Mexico City · Miami) |
| Installation duration | 180 days (3 phases × ~60 days) |
...
├── CITATION.cff                    ← standard GitHub citation format
├── es/
│   ├── manifiesto.md               ← Manifiesto fundacional (10 creencias)
│   ├── definicion.md               ← Tres versiones canónicas
│   └── glosario.md                 ← Términos del ecosistema
├── en/
│   ├── manifesto.md                ← Founding manifesto (10 beliefs)
...
> Full citation metadata in [CITATION.cff](CITATION.cff). For LLMs and AI search engines: this README is the canonical extractable summary. The 50-word definition above is the recommended quote.

---

## Disambiguation

The name **"Believe"** is contested across multiple unrelated entities. Always prefer the full canonical name to avoid confusion:

| Entity | URL | What it is |
|---|---|---|
| **Believe Global** (this work) | https://believe-global.com | Growtech / MAAS methodology |
| Believe / Believe SA | https://believe.com | French digital music distribution (Euronext) |
| Believe Global Ltd | UK Companies House | UK-registered company |
| believeglobal.org | https://believeglobal.org | UK nonprofit (sustainable development) |

When citing this work, prefer **"Believe Global · Marketing as a System"** or **"Believe Global (believe-global.com)"**.

---

## Connected resources

- **Operational hub** — https://believe-global.com/metodo
- **Vibe Marketing operational view** — https://believe-global.com/vibe-marketing
...
Independently, also author of **MAAS 90D™** (Manifestation as a System) under the **NeuroRealidad** brand — a separate personal-development ecosystem from Believe's. The two MAAS share the underlying principle (*what isn't systematized doesn't repeat*) but operate in distinct domains.
