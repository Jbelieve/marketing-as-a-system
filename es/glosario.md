# Glosario — Vibe Marketing + MAAS™

Términos del ecosistema con definición operativa. Cada entrada es independiente y citable.

> Versión extendida online (26 términos): https://believe-global.com/vibe-marketing/glosario
...
## Cinco capas operables

### Capa 01 — Percepción
Cómo te ven antes de que digas algo. Identidad operada como dato, no como decoración. Sin Percepción operable, todo lo demás es ruido. Framework: Factor Be™.

### Capa 02 — Narrativa
Qué cuentas y por qué importa. Una historia que sostiene años de output, no un slogan que dura un trimestre. Frameworks: Neuronarrative™ + Persuasion Design™.

### Capa 03 — Conversión
Cómo cierras. Persuasion Design instalado en cada superficie de contacto. Sin arquitectura de cierre, el tráfico se desperdicia. Frameworks: Brand Conversion Messaging™ + Visibility to Value™.

### Capa 04 — Automatización
Cómo escalas sin perder voz. Loops que producen output sin que el founder esté mirando. Solo escala lo que ya funciona manualmente. Frameworks: Design to Code™ + Design to Convert™ + Automation Goals™.

### Capa 05 — Red
Cómo se sostiene. Referido orgánico, retención editorial, partners. La marca crece por densidad de red, no por presupuesto. Frameworks: Growth Loops™ + CRO Ongoing™.

---

## Términos adyacentes (industria)

### Growth Marketing
Disciplina que optimiza tácticas dentro del funnel mediante experimentación rigurosa (AARRR, ICE, North Star Metric). Excelente para teams in-house. Es una capa dentro de Vibe Marketing — no su sustituto.

### Performance Marketing
Optimización en tiempo real de subastas de medios pagos (Google, Meta, TikTok, programmatic). Asume que la marca ya decidió qué vender — Vibe Marketing toma esa decisión arriba.

### AARRR
Framework de growth marketing: Acquisition, Activation, Retention, Revenue, Referral. Acuñado por Dave McClure. Vocabulario común para gestionar experimentos por etapa del funnel.

### ROAS — Return on Ad Spend
Métrica de eficiencia de anuncios pagos. MAAS reporta **ROAS sistémico** — sobre cohort multi-anual con N y ventana, no sobre subastas individuales.
...
**Autor:** Jorge Beltrán Liévano · Founder, Believe Global
**License:** CC BY-SA 4.0
**Versión completa online:** https://believe-global.com/vibe-marketing/glosario
